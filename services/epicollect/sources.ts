...
export const FALLBACK_SOURCES: EpicollectSource[] = [
  ...
  },
  {
    ...
    project_slug: "suivi-pluviometrique-koulikoro-ptcs",
    api_url: "https://five.epicollect.net/api/export/entries/suivi-pluviometrique-koulikoro-ptcs?form_ref=b08ac6bb9fcc46229ca70b7442315ff9_6a047a461c0c4&branch_ref=b08ac6bb9fcc46229ca70b7442315ff9_6a05a7178bf71",
    form_url: "https://five.epicollect.net/project/suivi-pluviometrique-koulikoro-ptcs",
    actif: true,
  },
  {
  ...
  },
  {
    ...
    project_slug: "suivi-piezo-koulikoro-ptcs",
    api_url: "https://five.epicollect.net/api/export/entries/suivi-piezo-koulikoro-ptcs?form_ref=6144ed6ab3d646baa82de06e13b4f051_6a047a461c0c4&branch_ref=6144ed6ab3d646baa82de06e13b4f051_6a05a7178bf71",
    form_url: "https://five.epicollect.net/project/suivi-piezo-koulikoro-ptcs",
    actif: true,
  },
  {
  ...
  },
  {
    ...
    project_slug: "suivi-limnimetrique-ce-koulikoro",
    api_url: "https://five.epicollect.net/api/export/entries/suivi-limnimetrique-ce-koulikoro?form_ref=bd5f4213890945cfb0d4976cd8768332_6a047a461c0c4&branch_ref=bd5f4213890945cfb0d4976cd8768332_6a05a7178bf71",
    form_url: "https://five.epicollect.net/project/suivi-limnimetrique-ce-koulikoro",
    actif: true,
  },
  {
...
export async function getActiveEpicollectSources(module?: string): Promise<EpicollectSource[]> {
  try {
    ...
    if (data?.length) {
      ...
      // V4.6 : la configuration embarquée corrige les trois sources BRANCH même si la table
      // epicollect_sources contient encore une ancienne URL form_ref.
      return rows.map((row)=>{
        const canonical=FALLBACK_SOURCES.find(x=>x.module===row.module&&x.type_source===row.type_source);
        const isBranch=["pluviometrie:releves","piezometrie:mesures","limnimetrie:lectures"].includes(`${row.module}:${row.type_source}`);
        return isBranch&&canonical?{...row,api_url:canonical.api_url}:row;
      });
    }
  } catch (_) {
...
export function withChildParentRef(source: EpicollectSource, _parent?: EpicollectSource | EpicollectSource[]) {
  // V4.6: les relevés PTCS sont des BRANCHES Epicollect5, pas des formulaires enfants.
  // branch_ref + form_ref sont déjà encodés dans api_url.
  return source;
}
