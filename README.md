...
## PSORE V4.0 — Observatoire intégré

Nouvelle page `/ouvrages` : référentiel consolidé CRR, PM et piézomètres, carte de 36 ouvrages, essais de pompage et disponibilité des analyses d’eau. Exécuter `database/10_observatoire_integre_ouvrages.sql` pour activer la saisie des prélèvements et des analyses.
