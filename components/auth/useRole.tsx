...
import { ROLE_ADMIN, ROLE_DNH, ROLE_PUBLIC, ROLE_SUPER_ADMIN, canAccessDashboard, canAccessObservatoire, canAccessReports, canExportAdvanced, canExportCsvXlsx, canManageUsers, canSync, canViewInternal } from "@/lib/permissions";
