...
function interpretation(module: ModuleName, stats: any) {
  ...
  if (!obs && nonExploitables > 0) return `${nonExploitables} enregistrement(s) synchronisé(s) ne sont pas exploitables car leur code de station n’est pas reconnu dans le référentiel officiel.`;
