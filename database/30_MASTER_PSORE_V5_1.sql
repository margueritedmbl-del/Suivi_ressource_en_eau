-- Correctif consolidé V5.1 : référentiels officiels, vues analytiques et rechargement PostgREST.
-- Réexécutable ; aucune donnée brute Epicollect5 n’est supprimée.
-- PSORE V5.1.0 — Référentiel physique, harmonisation PZ, analyses et scénarios
...
('piezometrie','PZ-DMB-SIN-001','PZ-02','Dombana','Doumba','["Sinzani"]','Correspondance harmonisée sur la localité Dombana; conserver la donnée brute Epicollect pour audit.',true),
...
('limnimetrie','CE-KLK-006_R-TNKA-PNT',null,'Tanaka','Doumba','[]',true),
...
('version_psore','5.1.0','Version applicative PSORE')
on conflict(key) do nothing;
update public.system_settings set value='5.1.0',updated_at=now() where key='version_psore';
