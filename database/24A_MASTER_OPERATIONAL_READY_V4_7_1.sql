...
-- ============================================================
-- Correctif V4.7.1 : supprimer d'abord les vues dépendantes
-- avant les vues canoniques. Ordre explicite, sans CASCADE.
-- ============================================================
...
insert into public.system_settings(key,value,description) values('version_psore','4.7.1','Version applicative PSORE')
on conflict(key) do update set value='4.7.1',updated_at=now();
