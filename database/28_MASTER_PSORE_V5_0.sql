-- PSORE V5.0.0 — Référentiel physique, harmonisation PZ, analyses et scénarios
...
('version_psore','5.0.0','Version applicative PSORE')
on conflict(key) do nothing;
update public.system_settings set value='5.0.0',updated_at=now() where key='version_psore';
