...
-- Charte de reporting PSORE V5.2.2 : définition centralisée du jour de pluie.
-- Référence documentaire MALI-METEO vérifiable. Le seuil peut être actualisé sans modifier le code.
insert into public.system_settings(key,value,description) values
('rainy_day_threshold_mm','0.1','Seuil opérationnel du jour de pluie utilisé par les rapports PSORE ; centralisé et modifiable.'),
('rainy_day_definition','Jour de pluie : précipitation journalière mesurable d''au moins 0,1 mm','Définition méthodologique retenue pour le reporting pluviométrique PSORE.'),
('rainy_day_reference_source','MALI-METEO — Bulletin GTPA, 1re décade août 2025','Source institutionnelle de référence pour le comptage des jours de pluie.'),
('rainy_day_reference_url','https://malimeteo.ml/documents/1310/Bulletin_GTPA_1dec_aout2025.pdf','Lien de la référence MALI-METEO utilisée.')
