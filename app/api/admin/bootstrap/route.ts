...
export async function GET(req: NextRequest) {
  ...
  if (serviceRoleStatus.isAnon || !serviceRoleStatus.present) {
    return errorJson(
      "SUPABASE_SERVICE_ROLE_KEY invalide : collez la Secret key/service_role du projet Supabase, pas la Publishable key/anon.",
      500,
      serviceRoleStatus
    );
  }
