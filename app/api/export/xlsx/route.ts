...
const TABLES: Record<string, string[]> = {
  pluviometrie: ["v_pluviometrie_dashboard_v451", "observations_pluvio"],
  piezometrie: ["v_piezometrie_dashboard_v451", "observations_piezo"],
  limnimetrie: ["v_limnimetrie_dashboard_v451", "observations_limni"],
