...
const CFG: Record<string, Cfg> = {
  pluviometrie: { view: "v_pluviometrie_dashboard_v47", table: "observations_pluvio", label: "Pluviométrie", valueKey: "pluie_24h_mm", dateKey: "date_observation", module: "pluviometrie", stationKey: "code_site" },
  piezometrie: { view: "v_piezometrie_dashboard_v47", table: "observations_piezo", label: "Piézométrie", valueKey: "niveau_statique", dateKey: "date_observation", module: "piezometrie", stationKey: "code_site" },
  limnimetrie: { view: "v_limnimetrie_dashboard_v47", table: "observations_limni", label: "Limnimétrie", valueKey: "hauteur_eau", dateKey: "date_observation", module: "limnimetrie", stationKey: "code_site" },
};
