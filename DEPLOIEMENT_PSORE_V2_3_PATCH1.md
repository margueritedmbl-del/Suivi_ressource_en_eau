...
La fonction de synchronisation ajoute automatiquement `per_page=100` et parcourt les pages disponibles afin de récupérer l’ensemble des entrées au lieu des 50 premières.
