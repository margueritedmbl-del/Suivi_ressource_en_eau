...
## 3.5.0 — SIG décisionnel
- Moteur de géotraitement léger côté application.
- Analyses spatiales automatiques par bassin, sous-bassin et commune Enabel.
- Analyse temporelle des niveaux piézométriques alimentée par Supabase.
- Tableau de bord d’impact des restaurations et couverture des piézomètres.
- Scénarios de surface, budget, potentiel relatif et priorisation des sous-bassins.
